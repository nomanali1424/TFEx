...
class ClassifierTrainer():
    ...
    def test(self, net):
        criterion = torch.nn.CrossEntropyLoss()
        self.model = net.to(device)
        a = torch.load(self.args.classification_model, map_location=device, weights_only=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--classification_model', type=str, default = r'C:\Users\Noman\Desktop\Github\TFEx\classification_models\cincecgtorso\resnet\resnet.pt', help='trained classifier model for testing')
    ...
    parser.add_argument('--task', type=str, default='spectralx', choices = ['spectralx', 'classification'])
